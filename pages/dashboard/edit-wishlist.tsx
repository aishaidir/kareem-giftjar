...
export default function EditWishlistPage() {
  ...
  return (
    <Box>
      <Head>
        <title>Edit wishlist - Kareem</title>
        <meta name="description" content="Kareem giftjar edit wishlist page" />
...
EditWishlistPage.getLayout = function getLayout(page: ReactElement) {
