...
export const FormHelper = styled(FormHelperText)`
  color: ${Colors.error};
  margin-top: -10px;
  font: normal normal normal 12/18px ${Fonts.secondary};
`;
// Text input
export const InputTextElement = styled.input<RootState>`
  ...
  margin: ${(props) => (props.vmargin ? props.vmargin : "10px")}
    ${(props) => (props.hmargin ? props.hmargin : 0)};
  padding: ${(props) => (props.vpadding ? props.vpadding : "22px")}
    ${(props) => (props.hpadding ? props.hpadding : "12px")};
  font: normal normal normal 14px/20px ${Fonts.secondary};
...
`;
//SEARCH FIELD
export const OutlinedSearchElement = styled.input<RootState>`
  width: ${(props) => (props.width ? props.width : "100%")};
  height: ${(props) => (props.height ? props.height : "40px")};
  margin: ${(props) => (props.vmargin ? props.vmargin : "10px")}
    ${(props) => (props.hmargin ? props.hmargin : 0)};
  padding: 14px 10px 14px 30px;
  font: normal normal normal 12px/10px ${Fonts.secondary};
  border-radius: 0;
  border-top: none;
  border-left: none;
  border-right: none;
...
export const SearchInputElement = styled.input<RootState>`
  ...
  font: normal normal 600 12px/23px ${Fonts.secondary};
...
`;
export const NumberInputElement = styled(NumericFormat)<RootState>`
  width: ${(props) => (props.width ? props.width : "100%")};
  height: ${(props) => (props.height ? props.height : "40px")};
  margin: ${(props) => (props.vmargin ? props.vmargin : "10px")}
    ${(props) => (props.hmargin ? props.hmargin : 0)};
...
export const InputLabelLabel = styled.span<RootState>`
  ...
  position: relative;
  top: 0px;
  font: normal normal normal 12px/25px ${Fonts.secondary};
  letter-spacing: 0px;
...
export const Text = styled.p<RootState>`
  ...
  font: normal normal normal 12px/18px ${Fonts.secondary};
  cursor: text;
  text-transform: none;
  letter-spacing: 0px;
`;
export const PageTitle = styled.h1`
  text-align: left;
  text-transform: capitalize;
  font: normal normal 700 30px/36px ${Fonts.secondary};
  letter-spacing: 0px;
  color: ${(props) => props.color || Colors.greyDark};
  @media only screen and (max-width: 600px) {
    color: ${(props) => props.color || Colors.light};
    font: normal normal 700 25px/30px ${Fonts.secondary};
  }
`;
export const PageSubTitle = styled.h4`
  text-align: left;
  text-transform: capitalize;
  font: normal normal 400 22px/26px ${Fonts.secondary};
  letter-spacing: 0px;
  color: ${(props) => props.color || Colors.textColor};
  margin-top: -5px;
  @media only screen and (max-width: 600px) {
    color: ${(props) => props.color || Colors.light};
    font: normal normal 400 16px/18px ${Fonts.secondary};
    margin-top: 0px;
  }
`;
export const Goback = styled.h4`
  display: flex;
  text-align: left;
  font: normal normal 600 12px/20px ${Fonts.secondary};
  color: ${Colors.disabled};
  cursor: pointer;
  &:hover {
    color: ${(props) => props.color || Colors.textColor};
...
export const DeleteTitle = styled.h2<RootState>`
  ...
  font: normal normal 600 16px/24px ${Fonts.secondary};
  letter-spacing: 0px;
...
export const AnimatedGradientText = styled.span`
  ...
  background-image: -webkit-linear-gradient(92deg, #f23913, #f59418);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
...
export const FormTitle = styled.h2<RootState>`
  text-align: ${(props) => props.align || "left"};
  text-transform: capitalize;
  font: normal normal 800 20px/20px ${Fonts.secondary};
  letter-spacing: 0px;
  color: ${(props) => props.color || Colors.greyDark};
  margin-top: 0;
  @media only screen and (max-width: 300px) {
    font: normal normal 800 18px/10px ${Fonts.secondary};
  }
`;
